// con snippets que instalé (no los del profe): a-service
...
export class HeroesService {
  ...
  // - nota: heroes: Heroe <--- antes era ":any", solo es posible por la INTERFAZ más abajo
  ...
  // 2) metodo para obtener nuestros heroes (PUBLIC ojo):
  getHeroes(): Heroe[] {
    return this.heroes;
  }
